...
const CONNEXA_DATA = {
  vagas: [
    ...
    { id: 3, cargo: "Desenvolvedor(a) Front-end", empresa: "Nimbus Tech", modalidade: "Remoto", local: "São Paulo, SP", area: "tecnologia", nivel: "pleno", publicada: "Hoje", cor: "#1F7A5C" },
    { id: 4, cargo: "Estágio em Design Gráfico", empresa: "Estúdio Raiz", modalidade: "Presencial", local: "Santo André, SP", area: "design", nivel: "estagio", publicada: "Há 1 dia", cor: "#FFB627" },
    ...
    { id: 6, cargo: "Assistente Financeiro", empresa: "Conta Certa Contabilidade", modalidade: "Híbrido", local: "Diadema, SP", area: "financeiro", nivel: "junior", publicada: "Há 4 dias", cor: "#15233B" },
  ...
  cursos: [
    { id: 1, nome: "Excel do Zero ao Avançado", instituicao: "Sebrae Regional ABC", carga: "20h", area: "negocios", modalidade: "online", preco: "gratuito", cor: "#FFB627" },
    { id: 2, nome: "Introdução ao Front-end Web", instituicao: "Connexa Academy", carga: "40h", area: "tecnologia", modalidade: "online", preco: "gratuito", cor: "#2D6E8E" },
    { id: 3, nome: "Empreendedorismo na Prática", instituicao: "Sebrae Regional ABC", carga: "16h", area: "negocios", modalidade: "presencial", preco: "gratuito", cor: "#1F7A5C" },
    { id: 4, nome: "Design de Marcas para Pequenos Negócios", instituicao: "Estúdio Raiz Academy", carga: "12h", area: "design", modalidade: "online", preco: "pago", cor: "#FF5A36" },
    { id: 5, nome: "Atendimento ao Cliente 4.0", instituicao: "Senac São Bernardo", carga: "24h", area: "negocios", modalidade: "hibrido", preco: "pago", cor: "#FFB627" },
    { id: 6, nome: "Marketing para Redes Sociais", instituicao: "Maré Criativa Academy", carga: "18h", area: "marketing", modalidade: "online", preco: "gratuito", cor: "#FF5A36" },
    { id: 7, nome: "Lógica de Programação", instituicao: "Connexa Academy", carga: "30h", area: "tecnologia", modalidade: "online", preco: "gratuito", cor: "#2D6E8E" },
    { id: 8, nome: "Gestão Financeira Pessoal", instituicao: "Sebrae Regional ABC", carga: "10h", area: "negocios", modalidade: "online", preco: "gratuito", cor: "#1F7A5C" },
  ],
